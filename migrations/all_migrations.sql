...
-- ============================================
-- MIGRATION 3: Roles and Permissions
-- ============================================
-- See 003_create_roles_and_permissions.sql for details

-- ============================================
-- MIGRATION 4: Organizations, Memberships, and Invitations
-- ============================================
-- See 004_create_organizations_and_memberships.sql for details
...
BEGIN
  ...
  RAISE NOTICE 'Countries inserted: %', country_count;
END $$;

-- Verify expertise was inserted
DO $$
DECLARE
  expertise_count INTEGER;
BEGIN
  SELECT COUNT(*) INTO expertise_count FROM expertise;
  RAISE NOTICE 'Expertise inserted: %', expertise_count;
END $$;
